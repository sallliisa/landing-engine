...
<div class="h-screen flex items-end bg-black/80 text-white w-full relative">
  ...
  <div class="w-full h-full absolute bottom-0 left-0 z-[1]" style="background: linear-gradient(to top right, rgba(0, 0, 0, 0.36) 0%, rgba(0, 0, 0, 0.18) 30%, rgba(0, 0, 0, 0) 100%);"></div>
