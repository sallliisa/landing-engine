...
<div class="flex flex-col">
  <div class="w-full flex flex-row items-center justify-center fixed z-[50]">
    <div class="flex flex-row items-center justify-between w-full px-12 pt-6 max-w-screen-xl">
